  ...
  <header class="py-4 border-b">
    <nav class="flex container items-center">
      <NuxtLink to="/" class="flex gap-1 items-center">
        <NuxtImg
          width="56px"
          src="/mudkipthumbnail2.png"
          format="webp"
          alt=""
        />
        <span class="text-3xl font-bold">Warin Saloon</span>
      </NuxtLink>
      <ul class="flex items-center gap-6 ml-auto text-xl font-bold capitalize">
        ...
        <li>
          <NuxtLink class="cursor-pointer" @click="goToAdmin()">Admin</NuxtLink>
        </li>
        <li v-if="!user">
